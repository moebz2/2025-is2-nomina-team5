    ...
    <div class="container p-10 mx-auto">
        ...
        <h1 class="text-3xl font-bold uppercase">Crear Rol</h1>
        ...
        <form action="{{ route('roles.store') }}" method="POST">
            ...
            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                <div class="sm:col-span-3">
                    ...
                    <div class="mt-2">
                        <input type="text" class="form-input" id="name" name="name" value="{{ old('name') }}"
                            required>
            ...
            <div class="mt-4">
                <button class="p-2 bg-blue-500 font-medium text-white rounded" type="submit">Crear Rol</button>
            </div>
        </form>
