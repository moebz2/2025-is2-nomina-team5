...
<div class="container mx-auto p-10">
        ...
        <div class="my-8 overflow-hidden">
            <table class="w-full table-auto border-collapse text-sm">
                <thead>
                    ...
                    <th class="border-b border-gray-200 p-4 pt-0 pb-3 pl-8 text-left font-medium text-gray-400 ">Incluye IPS</th>
                    ...
                    <tr>
                        ...
                        <td class="border-b border-gray-100 p-4 pl-8 text-gray-500">
                            @if ($concepto->ips_incluye)
                                <span class="rounded-lg bg-green-100 px-2 py-0.5 text-xs/6 font-semibold whitespace-nowrap text-green-700 ">Sí</span>
                            @else
                                <span class="rounded-lg bg-red-100 px-2 py-0.5 text-xs/6 font-semibold whitespace-nowrap text-red-700 ">No</span>
                            @endif
                        </td>
                        <td class="border-b border-gray-100 p-4 pl-8 text-gray-500">
                            @if ($concepto->estado)
                        ...
                        <td class="border-b flex gap-2 border-gray-100 p-4 pl-8 text-gray-500">
                            @can('concepto editar')
                            <a href="{{ route('conceptos.edit', $concepto->id) }}" class="hover:text-gray-700 cursor-pointer">
    ...
    <div class="mt-4">
        <a href="{{ route('conceptos.create') }}" class="bg-blue-500 p-2 rounded text-white font-medium">Crear nuevo concepto</a>
    </div>
</div>
@endsection