...
<div class="h-screen w-full flex items-center justify-center bg-gray-100">
    ...
    <div class="p-10 w-96 bg-white rounded-lg">
        ...
        <h2 class="text-3xl font-bold text-center">Sistema de nómina</h2>
        <div class="mt-4">
            <h3 class="text-center text-xl text-slate-800 font-medium">Inicie sesión</h3>
            ...
            <form action="{{ route('authenticate') }}" method="post">
                ...
                @if ($errors->any())
                <div class="text-sm text-red-500 mt-10">
                    <ul>
