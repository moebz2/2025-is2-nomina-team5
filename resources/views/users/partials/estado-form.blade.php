<div x-show="estadoForm == true" class="rounded border-5 border-dashed border-gray-300 mt-4 p-10 w-1/2 mx-auto" style="display: none">
    ...
    <form action="{{ route('users.cambiarEstado', $user->id) }}" method="POST">
        @csrf
            ...
            <div class="sm:col-span-3">
                ...
                <div class="mt-2">
                    <select id="estado" class="form-select" name="estado" required>
                        <option value="contratado">Activo</option>
                        <option value="inactivo">Vacaciones</option>
                        <option value="baja">Despedido</option>
                    </select>

                    <p class="text-sm text-gray-700 mt-1">
                        Los estados <b>Despedido</b> y <b>Vacaciones</b> impiden que el usuario ingrese a su cuenta
                    </p>
