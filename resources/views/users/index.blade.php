            ...
            <table class="min-w-full table-auto border-collapse text-sm">
                <thead>
                    <tr>
                        ...
                        <th class="border-b border-gray-200 p-4 pt-0 pb-3 text-left font-medium text-gray-400">Nacimiento Fecha</th>
                        <th class="border-b border-gray-200 p-4 pt-0 pb-3 text-left font-medium text-gray-400">Ingreso Fecha</th>
                        <th class="border-b border-gray-200 p-4 pt-0 pb-3 text-left font-medium text-gray-400">Salida Fecha</th>
                ...
                <tbody>
                    @foreach ($users as $user)
                        <tr>
                            ...
                            <td class="border-b border-gray-100 p-4 text-gray-500">{{ $user->nacimiento_fecha }}</td>
                            <td class="border-b border-gray-100 p-4 text-gray-500">{{ $user->empleado->fecha_ingreso ?? 'NA' }}</td>
                            <td class="border-b border-gray-100 p-4 text-gray-500">{{ $user->empleado->fecha_egreso ?? 'NA' }}</td>
