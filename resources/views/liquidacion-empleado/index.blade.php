                ...
                <table class="min-w-full table-auto border-collapse text-sm">
                    <thead>
                        <tr>
                            ...
                            <th class="border-b border-gray-200 p-4 pt-0 pb-3 text-left font-medium text-gray-400">Empleado
                            </th>
                        ...
                        @foreach ($liquidacionEmpleados as $liquidacionEmpleado)
                            <tr>
                                ...
                                <td class="border-b border-gray-100 p-4 text-gray-500">
                                    {{ $liquidacionEmpleado->empleado->nombre }}</td>
                                <td class="border-b border-gray-100 p-4 text-gray-500">{{ $liquidacionEmpleado->estado }}
                                </td>
                                <td class="border-b border-gray-100 p-4 text-gray-500">
