...
@section('content')
    <div x-data="{create : {{request('mode_create', "false")}}}" class="container mx-auto p-10">
        ...
        <div x-show="create" class="mt-4 p-4 bg-gray-100 rounded">
        ...
        <form action="{{route('movimientos.store')}}" method="POST">
            ...
            <div class=" mt-4 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                <div class="col-span-1 md:col-span-3">
                    <label for="create_empleado_id" class="block text-sm font-medium text-gray-700 mb-1">Empleado</label>
                ...
                <div class="sm:col-span-3">
                    <label for="create_monto" class="block text-sm font-medium text-gray-700">Monto del movimiento</label>
                    <div class="mt-2">
                ...
                <div class="sm:col-span-3">
                    <label for="create_validez_fecha" class="block text-sm font-medium text-gray-700">Fecha de validez</label>
                    <div class="mt-2">
                        <input type="date" name="create_validez_fecha" id="create_validez_fecha" value="{{ old('create_validez_fecha') }}" required
                            class="form-input">
                    </div>
                </div>
            ...
            <div class="mt-10 flex gap-4">
                ...
                <button x-show="create" x-on:click="create = false" class="px-2 py-1 flex items-center bg-red-500 rounded text-medium hover:bg-red-700 text-white">
            ...
            <form method="GET" class="grid grid-cols-1 md:grid-cols-6 gap-4">
                ...
                <div class="col-span-1 md:col-span-4 grid grid-cols-3 gap-4">
                    ...
                    <div>
                     ...
                     <div>
                        <label for="paginate" class="block text-sm font-medium text-gray-700 mb-1">Cantidad a mostrar</label>
                        <input type="number" name="paginate" min="1" max="50" step="1" id="paginate" value="{{ request('paginate',10) }}"
                            class="form-input w-full rounded border-gray-300">
                    </div>
                </div>
                ...
                <table class="min-w-full table-auto border-collapse text-sm">
                    <thead>
                        <tr>
                            ...
                            <th class="border-b border-gray-200 p-4 pt-0 pb-3 text-left font-medium text-gray-500">Monto (Gs)</th>
                            <th class="border-b border-gray-200 p-4 pt-0 pb-3 text-left font-medium text-gray-500">Tipo</th>
                            <th class="border-b border-gray-200 p-4 pt-0 pb-3 text-left font-medium text-gray-500">Validez</th>
                            {{-- <th class="border-b border-gray-200 p-4 pt-0 pb-3 text-left font-medium text-gray-500">Nacimiento
                            </th> --}}
                            <th class="border-b border-gray-200 p-4 pt-0 pb-3 text-left font-medium text-gray-500">Fecha creación
                            </th>
                    ...
                    <tbody>
                        @foreach ($movimientos as $movimiento)
                            <tr>
                                ...
                                <td class="border-b border-gray-100 p-4 font-medium">{{ $movimiento->concepto->nombre }}</td>
                                <td class="border-b border-gray-100 p-4 text-gray-700">{{ $movimiento->empleado->nombre }}</td>
                                <td class="border-b border-gray-100 p-4 text-gray-700">{{  number_format($movimiento->monto, 0, ',', '.')  }}</td>
                                ...
                                <td class="border-b border-gray-100 p-4 text-gray-700">{{ $movimiento->validez_fecha->format('F') }}</td>
                                <td class="border-b border-gray-100 p-4 text-gray-700">{{ $movimiento->generacion_fecha->format('d-m-Y') }}</td>
                                <td class="border-b border-gray-100 p-4 text-gray-700">
